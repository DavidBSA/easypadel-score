...
function pointsLabel(pointsA: number, pointsB: number, rules: Rules) {
  if (pointsA >= 3 && pointsB >= 3) {
    ...
    if (rules.goldenPoint) return { a: "GP", b: "GP", note: "Golden Point" };
...
function isGameOver(pointsA: number, pointsB: number, rules: Rules) {
  if (rules.goldenPoint && pointsA >= 3 && pointsB >= 3) return pointsA !== pointsB;
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "space-between", marginTop: 10 }}>
            <div style={{ textAlign: "left" }}>
              ...
              <div style={{ fontSize: 28, fontWeight: 900 }}>{state.setsA}</div>
            </div>
            ...
            <div style={{ textAlign: "right" }}>
              <div style={{ fontSize: 12, opacity: 0.75 }}>Sets</div>
              <div style={{ fontSize: 28, fontWeight: 900 }}>{state.setsB}</div>
            </div>
          </div>
